...
import com.hc.common.annotation.annotation.RedisCache;
...
public class RedisAop {
     ...
     */
    @Pointcut("@annotation(com.hc.common.annotation.annotation.RedisCache)")
    public void redisCache(){}

    /**
     *  给所有业务的数据的插入，更新，删除设置切点
     */
    @Pointcut("execution(* com.hc.modules.*.service..*.insert*(..)) || " +
              "execution(* com.hc.modules.*.service..*.batch*(..)) || " +
              "execution(* com.hc.modules.*.service..*.update*(..)) || " +
              "execution(* com.hc.modules.*.service..*.delete*(..))" )
