...
{
    var date = new Date();
    var by = date.getFullYear()-88; //最小值 → 10 年前
    var ey = date.getFullYear()+42; //最大值 → 10 年后
      ...
      tds[i].onclick = function () {
        if (calendar.dateControl != null){
          calendar.dateControl.value = new Date(calendar.date.getFullYear(),
            ...
            if(typeof(calendar.dateControl.getAttribute("onchange")) == "string")
            {
                if (calendar.dateControl.fireEvent)
                {
                    calendar.dateControl.fireEvent('onchange');
                }
                else
                {
